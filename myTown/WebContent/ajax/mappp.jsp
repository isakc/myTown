...
<h1>Spot</h1>
<div id="searchBox">
    <form id="frm" method="post" action="spotInsertForm.jsp">
        <fieldset>
            <input id="q" placeholder="상호 검색" autocomplete="off"/>
    ...
    <div id="btn">
    <button id="prevBtn" class="btnBtn">이전</button>
    <button id="nextBtn" class="btnBtn">다음</button>
    </div>
</div><!-- searchBox end -->
