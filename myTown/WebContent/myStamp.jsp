...
<%
	...
	List<SpotVo> spots = SpotsDAO.selectList(pageVo);
	
	UserVo user = UsersDAO.selectUserOne(no);
	
	List<SpotVo> stampSpot = SpotsDAO.spotStamps(pageVo);
	//List<SpotVo> stampSpot = StampsDAO.selectStamps(no);
	...
	String paging = PaginateUtil.paginate(now, total, numPage, numBlock, "myStamp.jsp", "now=");
%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>마이페이지 My Stamp</title>
